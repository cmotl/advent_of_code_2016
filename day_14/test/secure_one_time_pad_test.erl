-module(secure_one_time_pad_test).
-include_lib("eunit/include/eunit.hrl").

-import(secure_one_time_pad, [generate_hash/2, contains_triple/1, contains_quintuple/1, contains_exact_quintuple/2, is_key/2, quintuple_in_next_1000/3, generate_keys/3]).

should_generate_a_hash_test() ->
    Salt = "abc",
    Index = 0,
    ?assertEqual("a107ff634856bb300138cac6568c0f24", generate_hash(Salt, Index)).
